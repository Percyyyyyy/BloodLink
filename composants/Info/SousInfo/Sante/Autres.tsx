...
export default function Autres() {
    ...
    const { autresQuestionsAnswered, setAutresQuestionsAnswered } = useQuestionsAnswered();
    ...
    useEffect(() => {
        console.log('Autres questions answered state changed:', autresQuestionsAnswered);
    ...
    async function getResponsesForUser(idQuestionnaire, questionIDDD) {
        try {
            ...
            if(initialButtonColors.length == updatedButtonColors.length){
                setAutresQuestionsAnswered(true);
            }else{
                setAutresQuestionsAnswered(false);
            }
            setButtonColors(updatedButtonColors);
