...
export default function EtatSante() {
    ...
    const { etatSanteQuestionsAnswered, setEtatSanteQuestionsAnswered } = useQuestionsAnswered();
    ...
    useEffect(() => {
        console.log('Etat santé questions answered state changed:', etatSanteQuestionsAnswered);
    ...
    async function getResponsesForUser(idQuestionnaire, questionIDDD) {
        try {
            ...
            if(initialButtonColors.length == updatedButtonColors.length){
                setEtatSanteQuestionsAnswered(true);
            }else{
                setEtatSanteQuestionsAnswered(false);
            }
            setButtonColors(updatedButtonColors);
