...
export default function Historique() {
    ...
    const { historiqueQuestionsAnswered, setHistoriqueQuestionsAnswered } = useQuestionsAnswered();
    ...
    useEffect(() => {
        console.log('Historique questions answered state changed:', historiqueQuestionsAnswered);
    ...
    async function fetchQuestions() {
        try {
            ...
            if (idQuestionnaire) {
                await getResponsesForUser(idQuestionnaire, questionIds, initialButtonColors.length);
            } else {
                console.log("FALI");
            }
    ...
    async function getResponsesForUser(idQuestionnaire, questionIDDD, nbQuestion) {
        try {
            ...
            if(nbQuestion == updatedButtonColors.length){
                await setHistoriqueQuestionsAnswered(true);
            }else{
                await setHistoriqueQuestionsAnswered(false);
            }
            console.log(nbQuestion);
            console.log(updatedButtonColors.length);
            setButtonColors(updatedButtonColors);
            console.log(historiqueQuestionsAnswered, "value historique ");
            return data;
        } catch (error) {
            console.error('Erreur lors de l\'appel de la fonction get_responses_for_user:', error.message);
            return null;
    ...
    async function handleOptionSelect(option, index, idquestion) {
        try {
            ...
            // Update button colors more efficiently
