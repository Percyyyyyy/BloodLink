...
export default function Vaccin() {
    ...
    const { vaccinQuestionsAnswered, setVaccinQuestionsAnswered } = useQuestionsAnswered();
    ...
    useEffect(() => {
        console.log('Vaccin questions answered state changed:', vaccinQuestionsAnswered);
    ...
    async function getResponsesForUser(idQuestionnaire, questionIDDD) {
        try {
            ...
            if(initialButtonColors.length == updatedButtonColors.length){
                await setVaccinQuestionsAnswered(true);
            }else{
                await setVaccinQuestionsAnswered(false);
            }
            console.log(vaccinQuestionsAnswered, "value vaccin ");
