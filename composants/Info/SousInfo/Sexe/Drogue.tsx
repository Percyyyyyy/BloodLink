...
export default function Drogue() {
    ...
    const { drogueQuestionsAnswered, setDrogueQuestionsAnswered } = useQuestionsAnswered();
    ...
    useEffect(() => {
        console.log('Drogue questions answered state changed:', drogueQuestionsAnswered);
    ...
    async function getResponsesForUser(idQuestionnaire, questionIDDD, nbQuestion) {
        try {
            ...
            if(nbQuestion == updatedButtonColors.length){
                await setDrogueQuestionsAnswered(true);
            }else{
                await setDrogueQuestionsAnswered(false);
            }
            console.log(nbQuestion);
            console.log(updatedButtonColors.length);

            setButtonColors(updatedButtonColors);
            console.log(drogueQuestionsAnswered, "value drogue ");
