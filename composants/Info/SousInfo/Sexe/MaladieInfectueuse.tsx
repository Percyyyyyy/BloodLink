...
export default function Maladie() {
    ...
    const { maladieQuestionsAnswered,setMaladieQuestionsAnswered } = useQuestionsAnswered();
    ...
    useEffect(() => {
        console.log('Maladie questions answered state changed:', maladieQuestionsAnswered);
    ...
    async function getResponsesForUser(idQuestionnaire, questionIDDD, nbQuestion) {
        try {
            ...
            if(nbQuestion == updatedButtonColors.length){
                await setMaladieQuestionsAnswered(true);
            }else{
                await setMaladieQuestionsAnswered(false);
            }
            console.log(nbQuestion);
            console.log(updatedButtonColors.length);
            setButtonColors(updatedButtonColors);
            console.log(maladieQuestionsAnswered, "value maladie ");
            return data;
        } catch (error) {
            console.error('Erreur lors de l\'appel de la fonction get_responses_for_user:', error.message);
            return null;
