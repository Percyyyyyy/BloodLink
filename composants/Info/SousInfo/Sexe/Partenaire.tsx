...
export default function Partenaire() {
    ...
    const { partenaireQuestionsAnswered, setPartenaireQuestionsAnswered } = useQuestionsAnswered();
    ...
    useEffect(() => {
        console.log('Partenaire questions answered state changed:', partenaireQuestionsAnswered);
    ...
    async function getResponsesForUser(idQuestionnaire, questionIDDD, nbQuestion) {
        try {
            ...
            if(nbQuestion == updatedButtonColors.length){
                setPartenaireQuestionsAnswered(true);
            }else{
                setPartenaireQuestionsAnswered(false);
            }
            console.log(nbQuestion);
            console.log(updatedButtonColors.length);
            setButtonColors(updatedButtonColors);
            console.log(partenaireQuestionsAnswered, "value partenaire ");
