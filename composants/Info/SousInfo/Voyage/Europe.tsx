...
export default function Europe() {
    ...
    const { europeQuestionsAnswered, setEuropeQuestionsAnswered } = useQuestionsAnswered();
    useEffect(() => {
        fetchQuestions();
        console.log("---------------------------------------------------------------------------------");
    }, []);
    useEffect(() => {
        console.log('Vaccin questions answered state changed:', europeQuestionsAnswered);
    ...
    async function getResponsesForUser(idQuestionnaire, questionIDDD, nbQuestion) {
        try {
            ...
            if(nbQuestion == updatedButtonColors.length){
                await setEuropeQuestionsAnswered(true);
            }else{
                await setEuropeQuestionsAnswered(false);
            }
            console.log(nbQuestion);
            console.log(updatedButtonColors.length);

            setButtonColors(updatedButtonColors);
            console.log(europeQuestionsAnswered, "value europe ");
