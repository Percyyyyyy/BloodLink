...
export default function Monde() {
    ...
    const { mondeQuestionsAnswered,setMondeQuestionsAnswered } = useQuestionsAnswered();
    ...
    useEffect(() => {
        console.log('Vaccin questions answered state changed:', mondeQuestionsAnswered);
    ...
    async function getResponsesForUser(idQuestionnaire, questionIDDD, nbQuestion) {
        try {
            ...
            if(nbQuestion == updatedButtonColors.length){
                await setMondeQuestionsAnswered(true);
            }else{
                await setMondeQuestionsAnswered(false);
            }
            console.log(nbQuestion);
            console.log(updatedButtonColors.length);

            setButtonColors(updatedButtonColors);
            console.log(mondeQuestionsAnswered, "value monde ");
